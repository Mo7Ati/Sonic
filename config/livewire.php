...
return [
    ...
    */
    ...
    'payload' => [
        // Max size of a single Livewire request body (bytes). File fields can inflate in the payload;
        // keep this well above your largest uploads (e.g. 10 MB file → set ≥ 32 MB).
